      ...
      <div style={{ flex: 1 }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: '15px', borderBottom: '2px solid #111', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '15px' }}>
          ...
          <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
            ...
            <button tabIndex="0" className="btn-tv-focusable" onClick={() => { setActiveTab('movies'); setSearchQuery(''); }} style={{ backgroundColor: activeTab === 'movies' ? '#111' : '#141414', border: '1px solid #333', color: 'white', padding: '10px 25px', fontSize: '16px', fontWeight: 'bold', borderRadius: '8px', cursor: 'pointer' }}>
              {lang === 'ar' ? 'الأفلام' : 'Movies'}
            </button>
            <button tabIndex="0" className="btn-tv-focusable" onClick={() => { setActiveTab('shows'); setSearchQuery(''); }} style={{ backgroundColor: activeTab === 'shows' ? '#111' : '#141414', border: '1px solid #333', color: 'white', padding: '10px 25px', fontSize: '16px', fontWeight: 'bold', borderRadius: '8px', cursor: 'pointer' }}>
